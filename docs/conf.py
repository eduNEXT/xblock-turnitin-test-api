...
"""
xblock-turnitin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'xblock-turnitin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/xblock-turnitin",
...
#
# html_title = 'xblock-turnitin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Turnitin API integration first approach',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'turnitin'),
                os.path.join(root_path, 'turnitin/migrations')])
