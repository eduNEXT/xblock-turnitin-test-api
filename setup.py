...
VERSION = get_version('turnitin', '__init__.py')
...
setup(
    name='xblock-turnitin',
    version=VERSION,
    description="""Turnitin API integration first approach""",
    long_description=README + '\n\n' + CHANGELOG,
    author='eduNEXT',
    author_email='technical@edunext.co',
    url='https://github.com/eduNEXT/xblock-turnitin',
    packages=find_packages(
        include=['turnitin', 'turnitin.*'],
        exclude=["*tests"],
    ),
